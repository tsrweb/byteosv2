                ...
                <div class="col col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="div">Ticket N° <?=$idTicket?></div>
                            <div class="div"><?=$dataAberto?></div>
                        </div>
                        <div class="card-body">
                            ...
                            <form>
                                <div class="row">
                                    <div class="col col-lg-12">
                                        ...
                                        <input class="form-control" type="text" placeholder="<?=$empresa?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-lg-6">
                                        <label for="equipamento" class="form-label">Equipamento:</label>
                                        <input class="form-control" type="text" placeholder="<?=$equipamento?>" disabled>
                                    </div>
                                    <div class="col col col-lg-6">
                                        <label for="cnpj" class="form-label">Marca / Modelo:</label>
                                        <input class="form-control" type="text" placeholder="<?=$modelo?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-lg-7">
                                        <label for="logradouro" class="form-label">Código do Equipamento /
                                            Serial:</label>
                                        <input class="form-control" type="text" placeholder="<?=$codEquipamento?>" disabled>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-lg-12">
                                        <label for="logradouro" class="form-label">Defeito Relatado:</label>
                                        <textarea class="form-control" rows="5" placeholder="<?=$defeito?>" disabled></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-lg-12">
                                        <label for="servRealizado" class="form-label">Serviço Realizado:</label>
                                        <textarea class="form-control" rows="5" placeholder="<?=$solucao?>" disabled></textarea>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col col-lg-7">
                                        <label for="tecnico" class="form-label">Técnico:</label>
                                        <input type="text" class="form-control" placeholder="<?=$nomeTecnico?>" disabled>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col">
                                        <?php if($situacao == 'Em Aberto'){echo"<a href='finalizarTicket.php?idTicket=".$idTicket."'<buttom type='submit' class='btn btn-primary'>Finalizar</buttom></a>";}?>
